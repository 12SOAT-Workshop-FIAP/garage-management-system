...
describe('CustomerStatus', () => {
  ...
  it('should create active status explicitly', () => {
    const status = new CustomerStatus(true);
    expect(status.value).toBe(true);
    expect(status.isActive).toBe(true);
    expect(status.isInactive).toBe(false);
  });
  ...
  it('should create inactive status', () => {
    const status = new CustomerStatus(false);
  ...
  it('should compare equality correctly', () => {
    const status1 = new CustomerStatus(true);
    const status2 = new CustomerStatus(true);
    const status3 = new CustomerStatus(false);
