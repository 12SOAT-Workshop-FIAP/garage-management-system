...
export class Migration1754780839709 implements MigrationInterface {
    name = 'Migration1754780839709'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" SERIAL NOT NULL, "brand" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "plate" character varying(8) NOT NULL, "year" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "customerId" integer, CONSTRAINT "UQ_ec7181ebdab798d97070122a5bf" UNIQUE ("plate"), CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "work_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "customerId" uuid NOT NULL, "vehicleId" uuid NOT NULL, "description" text NOT NULL, "status" "public"."work_orders_status_enum" NOT NULL DEFAULT 'pending', "estimatedCost" numeric(10,2) NOT NULL DEFAULT '0', "actualCost" numeric(10,2), "laborCost" numeric(10,2), "partsCost" numeric(10,2), "diagnosis" text, "technicianNotes" text, "customerApproval" boolean NOT NULL DEFAULT false, "assignedTechnicianId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_29f6c1884082ee6f535aed93660" PRIMARY KEY ("id"))`);
